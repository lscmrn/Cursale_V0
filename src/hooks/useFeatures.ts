        ...
        seller: {
            ...
            items: [
                ...
                },
                {
                    ...
                    titleKey: 'features.seller.items.metrics.title',
                    descKey: 'features.seller.items.metrics.desc',
                },
            ],
        },
        manager: {
            ...
            items: [
                {
                    ...
                    titleKey: 'features.manager.items.dash.title',
                    descKey: 'features.manager.items.dash.desc',
                },
                {
                    id: 'feature-performance-analysis',
                    titleId: 'feature-title-performance-analysis',
                    descId: 'feature-desc-performance-analysis',
                    titleKey: 'features.manager.items.analysis.title',
                    descKey: 'features.manager.items.analysis.desc',
                },
                {
                ...
                },
                {
                    ...
                    titleKey: 'features.manager.items.best.title',
                    descKey: 'features.manager.items.best.desc',
                },
                {
        ...
        operations: {
            ...
            items: [
                ...
                },
                {
                    ...
                    titleKey: 'features.operations.items.loc.title',
                    descKey: 'features.operations.items.loc.desc',
                },
                {
